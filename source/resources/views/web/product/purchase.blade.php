            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center border-bottom pb-3 mb-3">
                        <img src="{{ asset($product->product_image) }}" class="img-fluid rounded me-3" style="width: 100px; height: 100px; object-fit: cover;" alt="{{ $product->product_name }}">
                        <div>
                            <h6 class="fw-bold mb-1">{{ $product->product_name }}</h6>
                            <p class="text-muted small mb-1">{{ $product->description }}</p>
                            <p class="fw-bold mb-0">₹{{ number_format($product->base_price, 2) }}</p>
                        </div>
                    </div>
