...
<div class="container" style="background-color: white;border-radius: 10px;width: 73%;padding: 40px 40px 30px 40px;margin-top: 160px;">
    ...
    <form class="login100-form validate-form" method="POST" action="{{ route('forgot_password.verifyOtp')}}">
        ...
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="col-sm-7" style="border-right: 1px solid #CCCCCC">
                <label for="otp-input" style="color: gray;">Enter OTP<span style="color: red;">*</span></label>
                <div class="input-group mb-3">
                    <input type="text" name="otp" style="max-width: 84%;" class="form-control" id="otp-input" aria-describedby="otp-help" required>
    ...
    <p style="color: gray;margin-top: 30px;">
        ...
        <a href="{{ route('userLogin') }}" style="color:#FB641B;">LOGIN</a>
    </p>
