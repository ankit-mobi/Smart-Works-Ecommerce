...
<div class="container" style="background-color: white;border-radius: 10px;width: 73%;padding: 40px 40px 30px 40px;margin-top: 160px;">
  ...
  <p>Your one-time password (OTP) is: **{{ $otp }}**</p> {{-- remove this line later for testing only--}}
...
<p style="color: gray;margin-top: 30px;">Already Registered <a href="{{ route('userLogin') }}" style="color:#FB641B; ">LOGIN</a></p>
