      ...
      <div class="row" style="margin-top: 20px;">
        ...
        <div class="col-sm-7" style="border-right: 1px solid #CCCCCC">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" name="user_name" style="max-width: 84%;" class="form-control" id="basic-url"
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" name="user_password" style="max-width: 84%;" class="form-control" id="basic-url"
              aria-describedby="basic-addon3">
          </div>


          <button type="submit" class="btn"
            style="background-color: #FB641B;color: white;width: 45%;font-size: 17px;margin-top: 20px;">Register</button>


    </form>
    <p style="color: gray;margin-top: 30px;">Already Registered on Growcer <a href={{route('userLogin')}}
