    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body text-center py-4">
                    {{-- Profile Image --}}
                    @if($user->user_image)
                        <img src="{{ asset($user->user_image) }}" alt="Profile Image" 
                             class="rounded-circle mb-3 shadow-sm" style="width:100px; height:100px; object-fit: cover;">
                    @else
            ...
            <div class="list-group shadow-sm" id="profile-tabs" role="tablist">
                <a class="list-group-item list-group-item-action active" id="account-tab" data-bs-toggle="list" href="#personal-info" role="tab" aria-controls="personal-info">
                    <i class="bi bi-person me-2"></i> My Account
                </a>
                <a class="list-group-item list-group-item-action" id="orders-tab" data-bs-toggle="list" href="#my-orders" role="tab" aria-controls="my-orders">
                    <i class="bi bi-bag me-2"></i> My Orders
                </a>
                <a class="list-group-item list-group-item-action" id="returns-tab" data-bs-toggle="list" href="#returns-cancel" role="tab" aria-controls="returns-cancel">
                    <i class="bi bi-arrow-counterclockwise me-2"></i> Returns & Cancel
                </a>
                <a class="list-group-item list-group-item-action" id="wishlist-tab" data-bs-toggle="list" href="#my-wishlist" role="tab" aria-controls="my-wishlist">
                    <i class="bi bi-heart me-2"></i> My Wishlist
                </a>
                <a class="list-group-item list-group-item-action" id="payment-tab" data-bs-toggle="list" href="#my-payment" role="tab" aria-controls="my-payment">
                    <i class="bi bi-credit-card me-2"></i> Payment
                </a>
                <a class="list-group-item list-group-item-action" id="password-tab" data-bs-toggle="list" href="#change-password" role="tab" aria-controls="change-password">
        ...
        <div class="col-md-9">
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="personal-info" role="tabpanel" aria-labelledby="account-tab">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                            ...
                            <a href="#" class="text-primary" data-bs-toggle="collapse" data-bs-target="#updateForm" aria-expanded="false" aria-controls="updateForm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $user->user_phone ?? 'Not Added' }}" disabled>
                            </div>
                            ...
                            <div class="collapse mt-4" id="updateForm">
                                <form action="{{ route('profile.update', $user->user_id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" name="useremail" value="{{ $user->user_email }}">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 text-md-end">
                                                <a href="{{ route('order.details', $order->order_id) }}" class="btn btn-sm btn-outline-info mt-2 mt-md-0">View Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="returns-cancel" role="tabpanel" aria-labelledby="returns-tab">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                            ...
                            @if($addresses->count())
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card border @if($address->select_status == 1) border-success @endif shadow-sm">
                                            <div class="card-body">
                                                <h6 class="fw-bold mb-1">{{ $address->receiver_name }}</h6>
                                                <p class="mb-1"><i class="bi bi-telephone me-1"></i>{{ $address->receiver_phone }}</p>
                                                <p class="mb-1 small text-muted">
                                                    {{ $address->house_no }}, {{ $address->society }} <br>
                                                    {{ $address->landmark }} <br>
                                                ...
                                                <div class="mt-2 d-flex justify-content-between">
                                                    <a href="{{ route('address.edit', $address->address_id) }}" class="btn btn-sm btn-outline-primary">
                                                        <i class="bi bi-pencil"></i> Edit
                                                    </a>
                                                    <form action="{{ route('address.destroy', $address->address_id) }}" method="POST" onsubmit="return confirm('Delete this address?');">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    @if($address->select_status == 0)
                                                        <form action="{{ route('address.setDefault', $address->address_id) }}" method="POST">
                                                            @csrf
...
<div class="modal fade" id="addAddressModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="" method="POST">   {{--{{ route('address.store') }}--}}
                @csrf
